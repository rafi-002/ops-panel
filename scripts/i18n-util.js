...
var translate = (function($) {
	...
	var RTL_KEY = 'format.right_to_left';
	
	return {
		/**
		 * Whether or not used language requires right to left layout (e.g. arabic translations)
		 */
		isRTL : function() {
			return this.msg(RTL_KEY).toLowerCase() === 'true';
		},
