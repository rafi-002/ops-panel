  ...
  * ====================== */
  ...
  MultiSelectOrder.prototype = {
    ...
    init: function(){
      ...
      if (ms.next('.ms-container').length === 0){
        ...
        ms.attr('id', ms.attr('id') ? ms.attr('id') : Math.ceil(Math.random()*1000)+'multiselectorder');
    ...
    'refresh' : function() {
      this.destroy();
      this.$element.multiSelectOrder(this.options);
    },
    ...
    'destroy' : function(){
      ...
      this.$element.removeData('multiselectorder');
    },
  ...
  $.fn.multiSelectOrder = function () {
    ...
    return this.each(function () {
      ...
      if (!data){ $this.data('multiselectorder', (data = new MultiSelectOrder(this, options))); }
  ...
  $.fn.multiSelectOrder.Constructor = MultiSelectOrder;
