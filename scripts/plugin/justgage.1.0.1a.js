 ...
 */
 ...
 /*
* version 1.0.1a 
* added font size for title font
*/
...
JustGage = function(config) { 
  ...
  this.config = 
  {
	...
	// min : int
    // min value
    titleFontSize : (config.titleFontSize) ? config.titleFontSize : 0,
  ...
  if (config.titleFontSize > 0) {titleFontSize = config.titleFontSize;}
  var titleX = dx + widgetW / 2;
  var titleY = dy + widgetH / 6.5;
  
  var titleFontFamily = "Arial";
  if (config.titleFontFamily !== undefined){ titleFontFamily = config.titleFontFamily};
  ...
  this.txtTitle. attr({
    ...
    "font-weight":"bold",
    "font-family":this.params.titleFontFamily,
